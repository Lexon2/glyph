...
public abstract class Hilt_BootHealthReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((BootHealthReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectBootHealthReceiver(UnsafeCasts.<BootHealthReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
